...
class Signup extends MY_Controller
{
    ...
    public function settings()
    {
        ...
        // $this->form_validation->set_rules('signup_emailopt1', 'Option 1');
        // $this->form_validation->set_rules('signup_emailopt2', 'Option 2');
        // $this->form_validation->set_rules('signup_unsubscribe', 'Unsubscribe', 'min_length[1]|max_length[1]');
        ...
        'class' => 'form-control',
        'id' => 'signup_email',
        'value' => set_value('signup_email', $this->uri->segment(3).'@'.$this->uri->segment(4)),
        'placeholder' => 'Type your email here...'
        ...
        'id' => 'signup_opt2',
        'value' => '1',
        'checked' => ($signup_opt1 == 2)? true:false,
        'style' => 'margin:10px'
      );
        ...
        // } else {
            if ($this->input->post('signup_unsub') == 1) {
                ...
                if ($this->Signup_model->delete($data)) {
                    echo "You've successfully unsubscribed";
                } else {
                    echo "Unsubscribe Error";
                }
            } else {
                $data = array(
          'signup_email' => $this->input->post('signup_email'),
